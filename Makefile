...
progs_srcs = $(progs:=.cc)
progs_objs = $(progs:=.o)
srcs = conf.cc io.cc Ngram.cc Hmm.cc NowayHmmReader.cc DecoderGraph.cc SWWGraph.cc SubwordGraph.cc WordGraph.cc LnaReaderCircular.cc Decoder.cc Segmenter.cc Lookahead.cc 
objs = $(srcs:.cc=.o)
