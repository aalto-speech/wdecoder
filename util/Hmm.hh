...
public:
    ...
    bool is_valid_duration_model(void) {
        return (a>0);
    }
...
public:
    ...
    inline bool is_source(int state) const {
        return state == 0;
    }
    inline bool is_sink(int state) const {
        return state == 1;
    }

    void set_pho_dur_stat(float m, float s) {
        pho_mean_dur = m;
        pho_dur_std = s;
    }
    float mean_dur(void) const {
        return pho_mean_dur;
    }
    float dur_std(void) const {
        return pho_dur_std;
    }
