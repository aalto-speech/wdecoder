...
void
ClassDecoder::read_phone_model(string phnfname)
{
...
void
ClassDecoder::read_duration_model(string durfname)
{
...
void
ClassDecoder::read_noway_lexicon(string lexfname)
{
...
void
ClassDecoder::read_dgraph(string fname)
{
...
void
ClassDecoder::set_hmm_transition_probs()
{
    for (unsigned int i=0; i<m_nodes.size(); i++) {
